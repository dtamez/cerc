...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('semester', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('cerc', ['Semester'])

        # Adding field 'Course.semester'
        db.add_column('course', 'semester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerc.Semester'], null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting model 'Semester'
        db.delete_table('semester')

        # Deleting field 'Course.semester'
        db.delete_column('course', 'semester_id')
    ...
    models = {
        ...
        'cerc.course': {
            ...
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cerc.Semester']", 'null': 'True'}),
