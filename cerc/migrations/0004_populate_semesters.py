...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # take the start date for each course
        # use the semester that matches as its semester or create if it does
        # not exist
        for course in orm.Course.objects.all():
            try:
                semester = orm.Semester.objects.get(start_date=course.start_date)
            except orm.Semester.DoesNotExist:
                semester = orm.Semester(name=str(course.start_date),
