...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactInfo.birthdate'
        db.add_column('contact_info', 'birthdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        for student in orm.Student.objects.all():
            if student.birthdate:
                student.student.birthdate = student.birthdate
                student.save()


    def backwards(self, orm):

        # Deleting field 'ContactInfo.birthdate'
        db.delete_column('contact_info', 'birthdate')
