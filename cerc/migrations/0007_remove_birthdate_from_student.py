...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.birthdate'
        db.delete_column('student', 'birthdate')


    def backwards(self, orm):

        # We cannot add back in field 'Student.birthdate'
        raise RuntimeError(
            "Cannot reverse this migration. 'Student.birthdate' and its values cannot be restored.")
