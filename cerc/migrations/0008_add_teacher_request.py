...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TeacherRequest'
        db.create_table('cerc_teacherrequest', (
        ...
        db.send_create_signal('cerc', ['TeacherRequest'])


    def backwards(self, orm):

        # Deleting model 'TeacherRequest'
        db.delete_table('cerc_teacherrequest')
