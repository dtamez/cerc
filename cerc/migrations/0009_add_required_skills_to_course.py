...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.required_skills'
        db.add_column('course', 'required_skills', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Course.required_skills'
        db.delete_column('course', 'required_skills')
