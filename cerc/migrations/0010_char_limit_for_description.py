...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('course', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000))


    def backwards(self, orm):

        # Changing field 'Course.description'
        db.alter_column('course', 'description', self.gf('django.db.models.fields.TextField')())
