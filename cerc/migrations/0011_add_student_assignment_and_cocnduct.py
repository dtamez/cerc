...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cerc', ['Assignment'])

        # Adding model 'StudentAssignment'
        db.create_table('cerc_studentassignment', (
            ('grade', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerc.Assignment'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerc.Student'])),
            ('turn_in_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('cerc', ['StudentAssignment'])

        # Changing field 'Course.approved'
        db.alter_column('course', 'approved', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TeacherRequest.approved'
        db.alter_column('cerc_teacherrequest', 'approved', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):

        # Deleting model 'Conduct'
        db.delete_table('conduct')

        # Deleting model 'Assignment'
        db.delete_table('cerc_assignment')

        # Deleting model 'StudentAssignment'
        db.delete_table('cerc_studentassignment')

        # Changing field 'Course.approved'
        db.alter_column('course', 'approved', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TeacherRequest.approved'
        db.alter_column('cerc_teacherrequest', 'approved', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'cerc.studentassignment': {
            ...
            'grade': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cerc.Student']"}),
            'turn_in_date': ('django.db.models.fields.DateField', [], {})
        },
        'cerc.teacher': {
