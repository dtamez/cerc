...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.instructions'
        db.add_column('cerc_assignment', 'instructions', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Assignment.instructions'
        db.delete_column('cerc_assignment', 'instructions')
