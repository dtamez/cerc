...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentAssignment.grade'
        db.alter_column('cerc_studentassignment', 'grade', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2, blank=True))

        # Changing field 'StudentAssignment.turn_in_date'
        db.alter_column('cerc_studentassignment', 'turn_in_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))


    def backwards(self, orm):

        # Changing field 'StudentAssignment.grade'
        db.alter_column('cerc_studentassignment', 'grade', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'StudentAssignment.turn_in_date'
        db.alter_column('cerc_studentassignment', 'turn_in_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'cerc.studentassignment': {
            ...
            'grade': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cerc.Student']"}),
