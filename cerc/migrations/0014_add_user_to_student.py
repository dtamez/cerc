...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('student', 'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True), keep_default=False)

        # Changing field 'Address.state'
        db.alter_column('address', 'state', self.gf('localflavor.us.models.USStateField')(max_length=2))


    def backwards(self, orm):

        # Deleting field 'Student.user'
        db.delete_column('student', 'user_id')

        # Changing field 'Address.state'
        db.alter_column('address', 'state', self.gf('localflavor.us.models.USStateField')())
