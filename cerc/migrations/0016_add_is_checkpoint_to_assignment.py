...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.is_checkpoint'
        db.add_column('cerc_assignment', 'is_checkpoint', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Assignment.is_checkpoint'
        db.delete_column('cerc_assignment', 'is_checkpoint')
