...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cerc_message', 'course', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cerc.Course']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Message.course'
        db.delete_column('cerc_message', 'course_id')
