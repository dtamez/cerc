...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Unit'
        db.create_table('cerc_unit', (
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerc.Course'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('cerc', ['Unit'])

        # Deleting field 'Assignment.course'
        db.delete_column('cerc_assignment', 'course_id')

        # Adding field 'Assignment.unit'
        db.add_column('cerc_assignment', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cerc.Unit']), keep_default=False)


    def backwards(self, orm):

        # Deleting model 'Unit'
        db.delete_table('cerc_unit')

        # Adding field 'Assignment.course'
        db.add_column('cerc_assignment', 'course', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cerc.Course']), keep_default=False)

        # Deleting field 'Assignment.unit'
        db.delete_column('cerc_assignment', 'unit_id')
    ...
    models = {
        ...
        'cerc.assignment': {
            ...
            'is_checkpoint': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
