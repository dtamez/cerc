...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.date'
        db.add_column('cerc_unit', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 9, 12)), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Unit.date'
        db.delete_column('cerc_unit', 'date')
