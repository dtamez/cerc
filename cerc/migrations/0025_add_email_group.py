...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.email_group_id'
        db.add_column('cerc_message', 'email_group_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Message.email_group_id'
        db.delete_column('cerc_message', 'email_group_id')
    ...
    models = {
        ...
        'cerc.message': {
            ...
            'email_group_id': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
