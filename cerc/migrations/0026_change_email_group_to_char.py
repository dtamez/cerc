...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.email_group_id'
        db.alter_column('cerc_message', 'email_group_id', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):

        # Changing field 'Message.email_group_id'
        db.alter_column('cerc_message', 'email_group_id', self.gf('django.db.models.fields.IntegerField')())
