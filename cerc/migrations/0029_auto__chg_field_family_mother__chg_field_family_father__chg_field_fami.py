...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Family.mother'
        db.alter_column('family', 'mother_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['cerc.ContactInfo']))

        # Changing field 'Family.father'
        db.alter_column('family', 'father_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['cerc.ContactInfo']))

        # Changing field 'Family.address'
        db.alter_column('family', 'address_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cerc.Address'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Family.mother'
        raise RuntimeError("Cannot reverse this migration. 'Family.mother' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Family.mother'
        db.alter_column('family', 'mother_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['cerc.ContactInfo']))

        # User chose to not deal with backwards NULL issues for 'Family.father'
        raise RuntimeError("Cannot reverse this migration. 'Family.father' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Family.father'
        db.alter_column('family', 'father_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['cerc.ContactInfo']))

        # User chose to not deal with backwards NULL issues for 'Family.address'
        raise RuntimeError("Cannot reverse this migration. 'Family.address' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Family.address'
        db.alter_column('family', 'address_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cerc.Address'], unique=True))
    ...
    models = {
        ...
        u'cerc.family': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cerc.Address']", 'unique': 'True', 'null': 'True'}),
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'emergency_name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'emergency_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'emergency_relationship': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'family_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30', 'blank': 'True'}),
            'father': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'father'", 'unique': 'True', 'null': 'True', 'to': u"orm['cerc.ContactInfo']"}),
            'fee_paid_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mother': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'mother'", 'unique': 'True', 'null': 'True', 'to': u"orm['cerc.ContactInfo']"}),
