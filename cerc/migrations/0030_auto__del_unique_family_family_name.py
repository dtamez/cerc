...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Family', fields ['family_name']
        db.delete_unique('family', ['family_name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Family', fields ['family_name']
        db.create_unique('family', ['family_name'])
